...
module.exports = {
    ...
    body: p => {
        ...
        ${''/* traces: these connect the THT terminals with the SMD pads */}
        (segment (start ${adjust_point(p, -3.81, 0)}) (end ${adjust_point(p, -1.65, 0)}) (width 0.25) (layer F.Cu) (net ${p.to.index}))
        (segment (start ${adjust_point(p, 3.81, 0)}) (end ${adjust_point(p, 1.65, 0)}) (width 0.25) (layer F.Cu) (net ${p.from.index}))
        
        (segment (start ${adjust_point(p, -3.81, 0)}) (end ${adjust_point(p, -1.65, 0)}) (width 0.25) (layer B.Cu) (net ${p.to.index}))
        (segment (start ${adjust_point(p, 3.81, 0)}) (end ${adjust_point(p, 1.65, 0)}) (width 0.25) (layer B.Cu) (net ${p.from.index}))
